  ...
  return (
    <div className="bg-background">
      <div className="container py-16 sm:py-24">
        ...
        <div className="py-16 bg-secondary -mx-4 px-4 sm:-mx-8 sm:px-8 md:-mx-16 md:px-16 rounded-lg">
            <div className="container mx-auto">
                ...
                {highlights.map((highlight, index) => (
                    <Card key={index} className="text-center shadow-md hover:shadow-xl transition-shadow duration-300 bg-background">
