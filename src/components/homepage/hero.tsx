...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="container relative z-10 grid min-h-[60vh] grid-cols-3 grid-rows-3 items-center justify-center py-20">
        ...
        <div className="col-start-1 col-span-3 row-start-2 flex flex-col items-center text-center">
